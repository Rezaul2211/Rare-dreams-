...
const addressBlock = `<label className="block text-xs font-bold text-neutral-700 uppercase tracking-wider mb-1.5">Full Address</label>
                  <input 
                    type="text" 
                    name="address" 
...
const newAddressBlock = `<label className="block text-xs font-bold text-neutral-700 uppercase tracking-wider mb-1.5">Full Address (House, Road, Area)</label>
                  <input 
                    type="text" 
                    name="address" 
                    placeholder="House/Road No., Area, Thana" 
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs font-bold text-neutral-700 uppercase tracking-wider mb-1.5">City</label>
                    <input 
                      type="text" 
                      name="city" 
                      placeholder="e.g. Dhaka" 
...
code = code.replace(addressBlock, newAddressBlock);

// Remove the free shipping indicator
code = code.replace(
